        ...
        <header className="mx-auto max-w-3xl text-center">
          <h2 className="font-heading text-4xl uppercase tracking-[0.02em] text-site-text sm:text-5xl">
            ...
            <p className="mt-4 text-base tracking-tight text-site-muted sm:text-lg">
              Discover artists and athletes at a glance. Open a profile for the full bio and details.
            </p>
        </header>
        ...
        <div className="max-w-[94%] mx-auto rounded-3xl border border-black/10 bg-linear-to-br from-[#ffb400]/12 via-white to-white p-4 shadow-[0_8px_28px_rgba(0,0,0,0.08)] sm:max-w-[90%] sm:p-6">
          ...
          {activeTab === "artists" ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex min-h-0 flex-1 flex-col p-6">
                      ...
                      <div className="mt-3 mb-6 h-22 shrink-0 overflow-hidden">
                        <p className="line-clamp-4 text-sm leading-relaxed text-site-muted">{artist.bio}</p>
                      </div>
                      <Link
                        href={`/entertainment/${artist.slug}`}
                        className="mt-auto flex w-full items-center justify-center rounded-full border border-[#ffb400]/55 px-5 py-3 text-sm font-semibold text-site-text transition hover:border-[#ffb400] hover:bg-[#ffb400] hover:text-white"
                      >
                        View Profile
                      </Link>
                    </div>
            ...
            <div
              ...
              className="mt-6 grid items-stretch gap-5 md:grid-cols-2"
            >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex min-h-0 flex-1 flex-col p-6">
                      ...
                      <div className="mt-3 mb-6 h-22 shrink-0 overflow-hidden">
                        <p className="line-clamp-4 text-sm leading-relaxed text-site-muted">{athlete.bio}</p>
                      </div>
                      <div className="mb-5 shrink-0 flex flex-wrap gap-2 text-sm">
                      ...
                      <Link
                        href={`/entertainment/${athlete.slug}`}
                        className="mt-auto flex w-full items-center justify-center rounded-full border border-[#ffb400]/55 px-5 py-3 text-sm font-semibold text-site-text transition hover:border-[#ffb400] hover:bg-[#ffb400] hover:text-white"
                      >
                        View Profile
                      </Link>
