...
export function PageHeroBand({ eyebrow, title, description, actions }: PageHeroBandProps) {
  return (
    <section className="section-white pt-0">
      <div className="mx-auto w-full max-w-full overflow-hidden bg-white" data-reveal>
        <div className="rounded-t-[2.25rem] bg-black px-6 py-16 text-white sm:px-10 sm:py-20">
