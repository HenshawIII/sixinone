        ...
        >
          ...
          <div className="mx-auto max-w-5xl">
            <div className={backgroundImage ? "relative z-10" : undefined}>
              <p className="font-heading text-xs uppercase tracking-[0.3em] text-white/65" data-reveal-text>
                {eyebrow}
              </p>
              <h1 className="mt-4 font-heading text-4xl leading-[1.02] sm:text-6xl" data-reveal-text>
                {title}
              </h1>
              <p className="mt-5 max-w-3xl text-base leading-relaxed text-white/80 sm:text-lg" data-reveal-text>
                {description}
              </p>
              {actions ? (
